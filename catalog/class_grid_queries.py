"""
ARQUIVO: leituras da grade do catálogo.

POR QUE ELE EXISTE:
- centraliza a leitura da agenda e da ocupação das aulas no app real do catálogo.

O QUE ESTE ARQUIVO FAZ:
1. monta o snapshot da grade de aulas para os próximos dias.
2. resume capacidade, ocupação e pressão operacional por aula e por dia.

PONTOS CRÍTICOS:
- mudanças aqui afetam a visão de agenda, ocupação e planejamento operacional.
"""
