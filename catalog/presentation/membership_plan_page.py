...
def build_membership_plan_page(*, form, plan, current_role_slug):
    ...
    hero = build_page_hero(
        eyebrow='Plano',
        title='Plano em leitura.',
        copy='Ajuste nucleo, proposta e impacto na carteira sem perder a clareza comercial.',
        actions=[
            {'label': 'Abrir nucleo', 'href': '#plan-form-core', 'kind': 'primary'},
            {'label': 'Ver leitura', 'href': '#plan-form-summary', 'kind': 'secondary'},
            {'label': 'Abrir financeiro', 'href': reverse('finance-center'), 'kind': 'secondary'},
        ],
        aria_label='Plano comercial',
        classes=['finance-hero', 'finance-plan-hero'],
        heading_level='h1',
        data_slot='hero',
