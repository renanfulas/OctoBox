...
from .views.student_views import (
    ...
    StudentPaymentCheckoutDrawerView,
    StudentPaymentDrawerView,
    StudentQuickSaleActionView,
    StudentQuickSaleDrawerView,
    StudentQuickSaleSuggestionsView,
    StudentStandalonePaymentDrawerView,
...
urlpatterns = [
    ...
    path('alunos/<int:student_id>/financeiro/cobranca/drawer/', StudentPaymentCheckoutDrawerView.as_view(), name='student-payment-checkout-drawer'),
    ...
    path('alunos/<int:student_id>/financeiro/cobranca/avulsa/drawer/', StudentStandalonePaymentDrawerView.as_view(), name='student-standalone-payment-drawer'),
    path('alunos/<int:student_id>/pagamentos-rapidos/drawer/', StudentQuickSaleDrawerView.as_view(), name='student-quick-sale-drawer'),
    path('alunos/<int:student_id>/pagamentos-rapidos/sugestoes/', StudentQuickSaleSuggestionsView.as_view(), name='student-quick-sale-suggestions'),
    path('alunos/<int:student_id>/pagamentos-rapidos/acao/', StudentQuickSaleActionView.as_view(), name='student-quick-sale-action'),
