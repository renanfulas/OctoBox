...
DOCUMENTO PAI:
- nenhum; este documento registra o primeiro marco funcional

QUANDO USAR:
- quando a duvida for o que foi decidido na V1, quais trade-offs apareceram e o que foi aprendido naquele ciclo
