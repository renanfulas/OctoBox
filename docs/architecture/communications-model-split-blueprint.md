...
TIPO DE DOCUMENTO:
- blueprint de split de dominio

AUTORIDADE:
- media

DOCUMENTO PAI:
- [domain-model-split-blueprint.md](domain-model-split-blueprint.md)

QUANDO USAR:
- quando a duvida for como mover o dominio de comunicacoes para ownership mais limpo sem quebrar models, imports ou migrations
