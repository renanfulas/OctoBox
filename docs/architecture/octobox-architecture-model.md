...
AUTORIDADE:
- alta, subordinada ao core conceitual

DOCUMENTO PAI:
- [octobox-conceptual-core.md](octobox-conceptual-core.md)

QUANDO USAR:
- quando a duvida for como as pecas arquiteturais do predio se organizam entre si e qual satelite consultar
...
O Beam e um modo extraordinario do topo emissor. Ele nao e rotina. Ele existe quando um estado extraordinario precisa de exposicao maxima.

Isso pode acontecer em duas chaves:

1. crise severa, falha critica de corredor, perda relevante de capacidade ou risco estrutural alto
2. sincronizacao estrutural rara, prontidao suprema e declaracao de que a obra atingiu base suficiente para novas alturas
