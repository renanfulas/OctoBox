...
QUANDO USAR:
- quando a duvida for em que ordem separar apps Django reais e com quais guardrails de compatibilidade
...
7. o plano tecnico da fase sensivel de models foi congelado em `communications-model-split-blueprint.md`
