...
TIPO DE DOCUMENTO:
- estrategia de frente e contrato da capacidade
...
QUANDO USAR:
- quando houver duvida sobre o que a Recepcao e, o que ela pode fazer e qual fronteira funcional deve ser preservada
...
1. este documento define a verdade funcional da capacidade Recepcao
2. o baseline da fase 0 diagnostica o estado atual, mas nao redefine o contrato da capacidade
3. o roteiro do Beam define ordem de execucao, mas nao altera sozinho a fronteira da Recepcao
