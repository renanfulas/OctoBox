...
- veja docs/boxcore-state-residue-inventory.md para a classificacao entre ancora estrutural e compatibilidade historica
- veja docs/promoted-public-facades-map.md para o mapa consolidado das superficies canonicas ja promovidas no runtime
