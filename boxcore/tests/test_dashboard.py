...
class DashboardViewTests(TestCase):
    ...
    def test_dashboard_renders_reading_list_metrics_and_sessions_for_authenticated_user(self):
        ...
        self.assertContains(response, "page-reading-list dashboard-reading-panel", html=False)
        self.assertContains(response, "is-emergency", html=False)
        self.assertContains(response, "is-warning", html=False)
        self.assertContains(response, "is-risk", html=False)
