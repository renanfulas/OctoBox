...
class FinanceChurnFoundationTests(TestCase):
    ...
    def test_finance_follow_up_analytics_identifies_smart_and_bad_divergence(self):
        ...
        self.assertIn('tirou a operação da melhor linha', analytics['turn_recommendation_learning']['bad_divergence']['summary'])
    ...
    def test_finance_follow_up_analytics_measures_turn_priority_tension_outcome(self):
        ...
        self.assertIn('adaptação humana', analytics['turn_priority_learning']['healthy_tension']['summary'])
        ...
        self.assertIn('dispersou a execução', analytics['turn_priority_learning']['dangerous_tension']['summary'])
