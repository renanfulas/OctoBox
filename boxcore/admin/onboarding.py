"""
ARQUIVO: configuração do Django admin para entrada de alunos e preparação de comunicação.

POR QUE ELE EXISTE:
- Organiza a fila de entrada e o preparo de contatos externos dentro do admin.
- Mantém a revisão de staging e comunicação já conectada à auditoria.

O QUE ESTE ARQUIVO FAZ:
1. Configura a central de entrada de alunos.
2. Configura contatos e logs de WhatsApp.
3. Reaproveita o mixin de auditoria nas alterações do backoffice.

PONTOS CRITICOS:
- Essas telas ajudam a revisar staging de dados antes do cadastro definitivo e precisam preservar rastreabilidade.
"""

from django.contrib import admin

from .mixins import AuditedAdminMixin
from boxcore.models import StudentIntake, WhatsAppContact, WhatsAppMessageLog
