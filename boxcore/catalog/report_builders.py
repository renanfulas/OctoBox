"""
ARQUIVO: builders especializados de exportacao do catalogo.

POR QUE ELE EXISTE:
- Remove das views a formatacao dos relatorios e centraliza a montagem dos payloads exportaveis.

O QUE ESTE ARQUIVO FAZ:
1. Monta payloads CSV e PDF para diretorio de alunos.
2. Monta payloads CSV e PDF para central financeira.
3. Mantem a formatacao de exportacao fora da camada HTTP.

PONTOS CRITICOS:
- A leitura pesada deve nascer em queries.py e chegar aqui apenas como snapshot ou queryset filtrado.
"""
