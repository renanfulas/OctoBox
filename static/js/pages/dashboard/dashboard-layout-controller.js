(function() {
  function createDashboardLayoutController(options) {
    ...
    function clearStatus() {
      ...
      statusNode.classList.add('visually-hidden');
    ...
    function persistLayout(payload, successMessage) {
      ...
      return fetch(saveUrl, {
        ...
        setStatus('A comunicação com o servidor falhou. Tente novamente.');
      });
    }
    ...
    function resetLayout() {
      persistLayout({ reset: true }, 'Layout restaurado para o padrão.');
    }
