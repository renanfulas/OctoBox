...
POR QUE ELE EXISTE:
- centraliza o feedback da grade dentro da fronteira operations.

O QUE ESTE ARQUIVO FAZ:
1. define mensagens de erro e sucesso da grade.
2. padroniza textos usados por policy, dispatcher e views.

PONTOS CRITICOS:
- qualquer mudanca aqui impacta feedback visual e testes da grade.
"""
