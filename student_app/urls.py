...
urlpatterns = [
    ...
    path('matricula/congelar/', StudentRequestFreezeView.as_view(), name='student-app-request-freeze'),
    ...
    path('consultoria/', StudentPublicWorkoutLinkView.as_view(), name='student-app-consultoria'),
