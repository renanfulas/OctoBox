    ...
    def get(self, request, *args, **kwargs):
        js = render_to_string(
            'student_app/sw.js',
            {
                ...
                'student_app_css_urls': [
                    '/static/css/student_app/app.css',
                    '/static/css/student_app/forms.css',
                    '/static/css/student_app/shell/shell.css',
                    '/static/css/student_app/shell/sidebar.css',
                    '/static/css/student_app/shell/topbar.css',
                    '/static/css/student_app/shell/mobile-nav.css',
                    '/static/css/student_app/shell/responsive.css',
                    '/static/css/student_app/primitives/layout.css',
                    '/static/css/student_app/primitives/eyebrow.css',
                    '/static/css/student_app/primitives/page-head.css',
                    '/static/css/student_app/primitives/chip.css',
                    '/static/css/student_app/primitives/card.css',
                    '/static/css/student_app/primitives/button.css',
                    '/static/css/student_app/primitives/flash.css',
                    '/static/css/student_app/primitives/pwa-activation.css',
                    '/static/css/student_app/primitives/hero-number.css',
                    '/static/css/student_app/primitives/primary-action.css',
                    '/static/css/student_app/primitives/progress-strip.css',
                    '/static/css/student_app/primitives/compact-state.css',
                    '/static/css/student_app/screens/home.css',
                    '/static/css/student_app/screens/grade.css',
                    '/static/css/student_app/screens/wod.css',
                    '/static/css/student_app/screens/rm.css',
                    '/static/css/student_app/screens/settings.css',
                ],
